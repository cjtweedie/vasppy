...
pristine_k7_EF_dos = Doscar("pristine_k7_EF_DOSCAR", ispin=1, lmax=2, lorbit=11, read_pdos=True, species=pristine_pos.get_chemical_symbols())
...
pristine_k7_EF_dos.plot_pdos(ax=ax5, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=pristine_k7_EF_dos.find_EF_range(), ymax=ymax_EF+20)
fig5.tight_layout()
fig5.savefig("pristine_k7_pdos.png")
