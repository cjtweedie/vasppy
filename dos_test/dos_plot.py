...
pristine_k5b_dos.plot_pdos(ax=ax2, colours=col, plot_total_dos=False, to_plot=orb_list_EF, xrange=xrange_EF)
fig2.tight_layout()
fig2.savefig("pristine_k5b_pdos.png")

fig3, ax3 = plt.subplots(1, 1, figsize=(8.0, 4.0))
pristine_k7_dos.plot_pdos(ax=ax3, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=xrange_EF)
fig3.tight_layout()
fig3.savefig("pristine_k7_pdos.png")

fig4, ax4 = plt.subplots(1, 1, figsize=(8.0, 4.0))
pristine_k7b_dos.plot_pdos(ax=ax4, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=xrange_EF)
fig4.tight_layout()
fig4.savefig("pristine_k7b_pdos.png")

fig5, ax5 = plt.subplots(1, 1, figsize=(8.0, 4.0))
min1_k5_dos.plot_pdos(ax=ax5, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=xrange_EF)
fig5.tight_layout()
fig5.savefig("min1_k5_pdos.png")

fig6, ax6 = plt.subplots(1, 1, figsize=(8.0, 4.0))
saddle_k5_dos.plot_pdos(ax=ax6, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=xrange_EF)
fig6.tight_layout()
fig6.savefig("saddle_k5_pdos.png")