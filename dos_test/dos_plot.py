...
pristine_k7b_dos.plot_pdos(ax=ax5, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=ymax_EF)
fig5.tight_layout()
...
im00_k7_dos.plot_pdos(ax=ax7, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=ymax_EF)
fig7.tight_layout()
fig7.savefig("min1_k7_pdos.png")

fig8, ax8 = plt.subplots(1, 1, figsize=(8.0, 4.0))
im04_k7_dos.plot_pdos(ax=ax8, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=ymax_EF)
fig8.tight_layout()
...
im02_k7_dos.plot_pdos(ax=ax10, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=ymax_EF)
fig10.tight_layout()
fig10.savefig("saddle_k7_pdos.png")

fig11, ax11 = plt.subplots(1, 1, figsize=(8.0, 4.0))
im01_k7_dos.plot_pdos(ax=ax11, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=ymax_EF)
fig11.tight_layout()
fig11.savefig("im01_k7_pdos.png")

fig12, ax12 = plt.subplots(1, 1, figsize=(8.0, 4.0))
im03_k7_dos.plot_pdos(ax=ax12, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=ymax_EF)
fig12.tight_layout()
