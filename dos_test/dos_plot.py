...
im01_k7_dos = Doscar("01_k7_DOSCAR", ispin=1, lmax=2, lorbit=11, read_pdos=True, species=saddle_pos.get_chemical_symbols())
im03_k7_dos = Doscar("03_k7_DOSCAR", ispin=1, lmax=2, lorbit=11, read_pdos=True, species=saddle_pos.get_chemical_symbols())
...
pristine_k7b_dos.plot_pdos(ax=ax5, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=670)
fig5.tight_layout()
...
min1_k7_dos.plot_pdos(ax=ax7, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF, ymax=670)
fig7.tight_layout()
...
im01_k7_dos.plot_pdos(ax=ax11, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF)
fig11.tight_layout()
fig11.savefig("im01_k7_pdos.png")

fig12, ax12 = plt.subplots(1, 1, figsize=(8.0, 4.0))
im03_k7_dos.plot_pdos(ax=ax12, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=Erange_EF)
fig12.tight_layout()
