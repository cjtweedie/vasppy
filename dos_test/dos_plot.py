...
pristine_k5_dos.plot_pdos(ax=ax1, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig1.savefig("pristine_k5_pdos.png")

fig2, ax2 = plt.subplots(1, 1, figsize=(10.5, 4.0))
pristine_k5b_dos.plot_pdos(ax=ax2, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig2.savefig("pristine_k5b_pdos.png")

fig3, ax3 = plt.subplots(1, 1, figsize=(10.5, 4.0))
pristine_k7_dos.plot_pdos(ax=ax3, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig3.savefig("pristine_k7_pdos.png")

fig4, ax4 = plt.subplots(1, 1, figsize=(10.5, 4.0))
min1_k5_dos.plot_pdos(ax=ax4, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig4.savefig("min1_k5_pdos.png")

fig5, ax5 = plt.subplots(1, 1, figsize=(10.5, 4.0))
saddle_k5_dos.plot_pdos(ax=ax5, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig5.savefig("saddle_k5_pdos.png")