...
saddle_dos = Doscar("saddle_DOSCAR", ispin=1, lmax=2, lorbit=11, read_pdos=True, species=saddle_pos.get_chemical_symbols())
pristine_dos = Doscar("pristine_DOSCAR", ispin=1, lmax=2, lorbit=11, read_pdos=True, species=pristine_pos.get_chemical_symbols())
...
min1_dos.plot_pdos(ax=ax1, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig1.savefig("min1_pdos.png")

fig2, ax2 = plt.subplots(1, 1, figsize=(10.5, 4.0))
saddle_dos.plot_pdos(ax=ax2, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig2.savefig("saddle_pdos.png")

fig3, ax3 = plt.subplots(1, 1, figsize=(10.5, 4.0))
pristine_dos.plot_pdos(ax=ax3, colours=col, plot_total_dos=True, to_plot=orb_list_EF, xrange=[-3,7])
fig3.savefig("pristine_pdos.png")